...
- [Core](core.md)
  ...
  - [Database Operations](database-operations.md#database-operations)
    ...
    - [Connections](database-operations.md#database-connections)
    - [DBMS](database-operations.md#dbms-api)
    - [Querying](database-operations.md#querying)
    - [Transactions](database-operations.md#transactions)

  - [Filtering](filtering-data.md#filters)

    - [Types](filtering-data.md#types-of-filters)
  ...
  - [File Formats](file-formats.md#file-formats)
    ...
    - [Additional Formats](file-formats.md#additional-formats)
    - [Input and Output](file-formats.md#Input-and-Output)
    - [Examples](file-formats.md#Example-Global-Supply-Chain-Integration)
...
- [Wiring](convirgance-wiring.md#wiring-compositional-configuration)
  ...
  - [Arrays](convirgance-wiring.md#arrays)
...
- [Web](convirgance-web.md#convirgance-web)
  ...
  - [Getting Started](convirgance-web-quickstart.md)
    - [Maven Archetype](convirgance-web-quickstart.md#Maven-Archetype)
    - [Manual Setup](convirgance-web-quickstart.md#Manual-Configuration)
  - [Services](convirgance-web-services.md)
    - [URL Paths](convirgance-web-services.md#URL-Paths)
    - [Concepts](convirgance-web-services.md#Common-Concepts)
    - [Implementations](convirgance-web-services.md#Services)
  - [Hypermedia](convirgance-web-hypermedia.md)
    - [Structure](convirgance-web-hypermedia.md#Basic-Structure)
    - [Verbs](convirgance-web-hypermedia.md#Understanding-Verbs)
    - [REST](convirgance-web-hypermedia.md#REST-Service-Backend)
    - [Forms](convirgance-web-hypermedia.md#HTML-Forms)
  - [Tag Library](convirgance-web-taglib.md)
    - [Usage](convirgance-web-taglib.md#Usage)
    - [Functions](convirgance-web-taglib.md#Functions)
    - [JSON](convirgance-web-taglib.md#JSON)
    - [Service Call](convirgance-web-taglib.md#Service-Call)
    - [Control Flow](convirgance-web-taglib.md#Control-Flow)
    - [Database Query](convirgance-web-taglib.md#Database-Query)
  - [Configuration](convirgance-web-boot.md)
    - [Dependencies](convirgance-web-boot.md#Dependencies)
    - [Properties](convirgance-web-boot.md#Properties)
